...
/**
 * Servlet implementation class SimpleAuth
 */
@WebServlet("/SimpleAuth")
public class SimpleAuth extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String authServer = SageoneConstants.SIMPLE_SIGNUP_ENDPOINT;
		String queryParams = "?response_type=code&client_id=" + clientId + "&redirect_uri=" + callbackUrl;
