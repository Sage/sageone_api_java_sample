...
public class SageoneConstants {
	...
	public static final String AUTH_ENDPOINT = "https://www.sageone.com/oauth2/auth";
	public static final String TOKEN_ENDPOINT = "https://api.sageone.com/oauth2/token";
}